...
point to a series of acharacters.  For C they are null terminates ("\0").  L<FFI::Platypus> handles
...
Care needs to be taken with scoping and closures, because of the way Perl and C handle responsability
...
allow some of the flexability of custom types written in Perl, with potential performance improvements
of native code.
