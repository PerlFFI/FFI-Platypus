...
subtest 'void return type' => sub {
  ...
  is $sig->return_type->language, 'ffi', 'return type language = ffi';
  ...
  is $sig->argument_type(0)->language, 'ffi', 'argument 1 type language = ffi';
...
subtest 'void argument type' => sub {
  ...
  eval { ffi_signature ffi_type ffi => 'void', ffi_type ffi => 'void' };
