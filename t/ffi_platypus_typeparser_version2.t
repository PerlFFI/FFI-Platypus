...
use FFI::Platypus::TypeParser::Version2;
use Data::Dumper qw( Dumper );

my $tp = FFI::Platypus::TypeParser::Version2->new;
...
subtest 'fixed record / fixed string' => sub {
  ...
  subtest 'ten record pass-by-value' => sub {

    local $@;
    eval { $tp->parse("record(10)") };
    like "$@", qr/^classless record not allowed as value type/;
